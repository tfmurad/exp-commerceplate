		...
		<>
			<Listbox onChange={handleLogout}>
				<div className="relative">
					{
						user ? <Listbox.Button className="relative cursor-pointer text-left sm:text-xs flex items-center justify-center">
					...
					>
						<Listbox.Options className="z-20 text-center absolute w-full md:overflow-hidden">
							<Listbox.Option
								value={'Logout'}
							>
								<button className="btn btn-primary max-md:btn-sm mt-2">Logout</button>
							</Listbox.Option>
						</Listbox.Options>
					</Transition>
				</div>
