		...
		<>
			...
			>
				...
				<div className="modalCart-header">
					<p className="text-dark dark:text-darkmode-dark text-2xl font-medium">Your Cart</p>
				...
				<div className="modalCart-content">
					<div className="flex flex-col justify-center items-center space-y-6">
						...
						<Link href={"/product"} className="btn btn-primary w-full">Continue Shopping</Link>
					</div>
				</div>
			</div>
		</>
