      ...
      <div className="">
        <div className="row">
          ...
          >
            ...
            />
            <button
              className="rounded-none btn btn-sm md:btn-md btn-primary cursor-pointer bg-theme-light dark:bg-darkmode-theme-light border-none text-dark dark:text-darkmode-light"
            >
              <IoSearch size={25} />
            </button>
          </form>
