            ...
            return (
              <div key={value} className="mb-2">
                ...
                >
                  ...
                  {option.name === "Color" ? (
                    <div key={value} className={`relative rounded-md overflow-hidden ${isActive && "border border-dark dark:border-darkmode-dark outline-none"}`}>
                      <Image src={imageMap[value]} alt={value} width={50} height={50} />
                      {isActive && (
