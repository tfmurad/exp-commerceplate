        ...
        <div className="row">
          ...
          >
            ...
            >
              ...
              <div
                className={`hidden lg:flex justify-between w-full absolute top-1/2 z-10 px-6 text-dark ${isHovered ? 'opacity-100 transition-opacity duration-300 ease-in-out' : 'opacity-0 transition-opacity duration-300 ease-in-out'
                  }`}
              >
